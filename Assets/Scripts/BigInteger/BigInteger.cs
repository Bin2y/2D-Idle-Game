...
public class BigInteger
{
    ...
    public List<string> units = new List<string> { "a", "b", "c", "d", "e", "f" };
    public string BigIntergerToUnit()
    {
        BigInteger bigInteger = this;
        string str = bigInteger.ToString(10);
        int unitIndex = 0;
        ...
        if(str.Length>3)
        {
            ...
            if (str.Length > 4)
            {
                return (newInt / 1000).ToString() + units[unitIndex];
            }
            else
            {
                return (newInt / 1000f).ToString("0.0") + units[unitIndex];
            }
        }
        else
        {
